...
function DD() {
  ...
  if (typeof window !== 'undefined' && typeof window.location !== 'undefined' && typeof window.location.origin !== 'undefined') {
...
DD.prototype.deleteService = function deleteService(sname) {
...
DD.prototype.postTrain = function postTrain(sname, data, parameters) {
...
DD.prototype.getTrain = function getTrain(sname) {
...
DD.prototype.deleteTrain = function deleteTrain(sname) {
  var job = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var params = {
    service: sname,
    job: job
...
DD.prototype._httpRequest = function _httpRequest(httpMethod, apiMethod) {
  var _this = this;
  ...
  return new Promise(function () {
    ...
    regeneratorRuntime.mark(function _callee(resolve, reject) {
      var url, requestParams, urlParameters;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              url = _this.ddurl + apiMethod;
              requestParams = {
                method: httpMethod
              };
              ...
              if (jsonParams != null) {
                ...
                urlParameters = Object.entries(searchParams).map(function (e) {
                  return e.join('=');
                }).join('&');
...
DD.prototype._get = function _get(method) {
...
DD.prototype._put = function _put(method) {
  var json = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var params = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
DD.prototype._post = function _post(method) {
  var json = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var params = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
DD.prototype._delete = function _delete(method) {
  var json = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  var params = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
